...
Agha and Thati proposed a typed asynchronous variant of \(\pi\)-calculus called A\(\pi\)-calculus whose type system imposes these properties.
In A\(\pi\)-calculus, the soundness of the type system means that a typed term certainly behaves as an actor configuration.
This paper reports our formal proof of the soundness using Coq by reconsidering the definitions of the terms and types of the calculus.
\end{abstract}
...
\keywords{Actors, Pi-calculus, Coq, Types, Soundness
